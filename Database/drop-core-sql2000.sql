...
DROP CONSTRAINT FK_Cuyahoga_SectionRole_1 
go

ALTER TABLE Cuyahoga_SectionRole
DROP CONSTRAINT FK_Cuyahoga_SectionRole_2 
go

ALTER TABLE Cuyahoga_NodeRole
DROP CONSTRAINT FK_Cuyahoga_NodeRole_1 
go
...
ALTER TABLE Cuyahoga_Section
DROP CONSTRAINT FK_Cuyahoga_Section_2 
go

ALTER TABLE Cuyahoga_Node
DROP CONSTRAINT FK_Cuyahoga_Node_1 
go
...
ALTER TABLE Cuyahoga_UserRole
DROP CONSTRAINT FK_Cuyahoga_UserRole_2 
go
...
DROP TABLE Cuyahoga_UserRole
go


DROP TABLE Cuyahoga_Role
go


DROP TABLE Cuyahoga_User
go
