...
namespace Cuyahoga.Modules.Articles
{
	...
	{
		[TableColumn("commentid"), PrimaryKey(AutoGenerated=true), SequenceName("cm_articlecomment_commentid_seq")]
		private int _id;
		...
		public Article Article
		{
			...
			{ 
				...
				{
					Key key = new Key(typeof(Article), true, "_id", this._articleId);
