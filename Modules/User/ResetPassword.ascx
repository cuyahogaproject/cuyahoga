<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ResetPassword.ascx.cs" Inherits="Cuyahoga.Modules.User.ResetPassword" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
